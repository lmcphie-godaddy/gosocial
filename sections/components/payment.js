        ...
        <form>
          <div className={paymentStyles.inputFields}>
            <div className={paymentStyles.firstLine}>
              <label id="cardholderLabel" htmlFor="holderName">
                Cardholder Name
              </label>
              <br></br>
              <input
            ...
            <div className={paymentStyles.secondLine}>
              <div className={paymentStyles.box}>
                <label id="cardNumberLabel" htmlFor="cardNumber">
                  Card Number
                </label>
                <br></br>
                <input
                  type="text"
                  id="cardNumber"
                  placeholder="987654321111"
                ></input>
              </div>
              <div className={paymentStyles.box}>
                <label id="expirationLabel" htmlFor="expiration">
                  Expiration Date
                </label>
                <br></br>
                <input
              ...
              <div className={paymentStyles.box}>
                ...
                <br></br>
                <input type="text" id="cvv" placeholder="000"></input>
                <br></br>
                <br></br>
              </div>
            </div>
            <div className={paymentStyles.thirdLine}>
              <label id="billingLabel" htmlFor="billing">
                Billing Address
              </label>
              <br></br>
              <input
